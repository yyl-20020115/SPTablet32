...
BYTE 0   1  1  L  R  Y7 Y6 X7 X6 (11000000 if start frame)
BYTE 1   0  0  X5 X4 X3 X2 X1 X0 (10000000 if start frame)
BYTE 2   0  0  Y5 Y4 Y3 Y2 Y1 Y0 (10000000 if start frame)
*/
